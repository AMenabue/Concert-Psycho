...
/** Top inset for subpage headers (back + title), below mobile browser chrome. */
export const APP_SUBPAGE_HEADER_STYLE: CSSProperties = {
...
export const APP_SUBPAGE_BODY_CLASS =
  "relative z-10 mx-auto mt-3 flex min-h-0 w-full max-w-[430px] flex-1 flex-col";
